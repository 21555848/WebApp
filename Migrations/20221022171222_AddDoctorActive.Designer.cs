...
namespace WebApp.Migrations
{
    ...
    [Migration("20221022171222_AddDoctorActive")]
    partial class AddDoctorActive
    {
            ...
            modelBuilder.Entity("WebApp.Models.CreditCard", b =>
                {
                    b.HasOne("WebApp.Models.PatientProfile", "PatientProfile")
                        .WithOne("CreditCard")
                        .HasForeignKey("WebApp.Models.CreditCard", "PatientProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
